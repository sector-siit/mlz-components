...
const meta: Meta<typeof Button> = {
	...
	parameters: {
		...
		docs: {
			description: {
				component:
					"Un componente de botón personalizable con diferentes variantes y tamaños. Utiliza variables CSS para permitir personalización desde el proyecto consumidor.",
			},
		},
	},
	tags: ["autodocs"],
